...
| B-25 | 어댑터·설정 정리 — non-callback prop 미반영 문서화(특히 `panels`), react-dom peer 제거, biome 무효 억제 정리, deploy-demo `paths:` 필터, ScrollLock scrollY 주석 명확화, StableInput 옵션 검증 | M | audit-code P2 ×6 | ✅ Sprint 11 |
